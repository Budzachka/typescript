...
type TriangleResult =
  ...
  | "The angles of the triangle must be acute"
  | "The sum of two sides less any side of the triangle .Calculations are impossible";

console.log(
  `Use: triangle(value1, type1, value2, type2)
...
function triangle(
  value1: number,
  type1: TriangleParamType,
  value2: number,
  type2: TriangleParamType
): TriangleResult {
  const validTypes: TriangleParamType[] = [
    "leg",
    "hypotenuse",
    "adjacent angle",
    "opposite angle",
  ...
  if (
    (type1 === "hypotenuse" && type2 === "leg" && value1 - value2 <= 0) ||
  ...
  if (
    ((type1 === "angle" && value1 >= 90) || (type2 === "angle" && value2 >= 90)) ||
